...
public class StudyRoomController {
    ...
    public String joinRoom(@PathVariable Long id,
        ...
        // ⚠️ 여기서부터는 전부 메모리에서 필터링 → 안전함

        // 이미 참여한 사람인지 체크 (중복 참여 방지)
    ...
    // 🔵 방 참여 인원 목록 보기 : GET /rooms/{id}/members
    ...
    // 🔴 방 나가기 : DELETE /rooms/{id}/leave?username=아이디
    ...
    // 🔴 방 삭제하기 : DELETE /rooms/{id}?host=방장아이디
    @DeleteMapping("/{id}")
