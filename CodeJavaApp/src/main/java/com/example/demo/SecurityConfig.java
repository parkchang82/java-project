...
public class SecurityConfig {
    ...
    // 🚨 1. JwtUtil 및 UserDetailsService 주입
    private final JwtUtil jwtUtil;
    private final UserDetailsService userDetailsService; 

    // 생성자를 통한 의존성 주입 (Spring이 자동으로 Bean을 찾아서 넣어줍니다)
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "http://127.0.0.1:3000", "https://project-frontend-f1zp.onrender.com")); 
    ...
    // 4. Security Filter Chain (인증/인가 규칙) 설정
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            // JWT 필터 추가
            // 🚨 4.2. JWT 필터를 UsernamePasswordAuthenticationFilter 전에 추가하여,
            //         매 요청마다 헤더의 토큰을 검증하게 합니다.
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                // 💡 [추가] Preflight 요청(OPTIONS)은 모두 허용
